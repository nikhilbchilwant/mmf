...
class AirstoreDatasetBuilder(MMFDatasetBuilder):
    def __init__(self, dataset_name="airstore", *args, **kwargs):
    ...
    def build(self, config: AirStoreConfigType, *args, **kwargs):
        # No need to build in fb datasets
        pass

    def build_transform(self, config: AirStoreConfigType, key: str = "batch_processor"):
    ...
    def build_filters(self, config: AirStoreConfigType, dataset_type: str):
    ...
    def load(
        self, config: AirStoreConfigType, dataset_type: str = "train", *args, **kwargs
    ) -> Type[Dataset]:
        ...
        dataset = AirStoreDataset(
            airstore_uri="airstore://coco_caption_train_flashblade",
            transform=self.build_transform(config),
        )
